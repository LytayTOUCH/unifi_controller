...
echo -e "${GREEN}#         ${RESET}Installing UniFi Controller 5.10.25!         ${GREEN}#${RESET}"
echo -e "${GREEN}#                                                      #${RESET}"
echo -e "${GREEN}########################################################${RESET}"
echo ""
sleep 2
...
wget https://dl.ui.com/unifi/5.10.25/unifi_sysvinit_all.deb || abort
...
if [[ $(dpkg -l | grep "unifi " | grep -c "ii") -eq 1 ]]; then
  ...
  echo ""
  echo ""
  echo -e "${GREEN}#${RESET} UniFi SDN Controller 5.10.25 has been installed successfully"
  ...
  echo ""
  echo ""
  echo " Failed to successfully install UniFi SDN Controller 5.10.25"
  echo ""
